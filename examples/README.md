# MAC Address Lookup API - Examples

This folder contains example code for using the MAC Address Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/macaddresslookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/macaddresslookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/macaddresslookup](https://docs.apiverve.com/ref/macaddresslookup)
