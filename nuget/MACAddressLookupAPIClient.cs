...
namespace APIVerve.API.MACAddressLookup
{
    ...
    /// <summary>
    /// Client for the MACAddressLookup API
    /// </summary>
    public class MACAddressLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/macaddresslookup";
        ...
        {
            { "mac", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public MACAddressLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MACAddressLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MACAddressLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MACAddressLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MACAddressLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(MACAddressLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MACAddressLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MACAddressLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MACAddressLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MACAddressLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MACAddressLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MACAddressLookupQueryOptions options)
        {
