...
namespace APIVerve\Macaddresslookup;
...
/**
 * Client for the MAC Address Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/macaddresslookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/macaddresslookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MacaddresslookupClient] {$message}\n";
        }
    }
}
