# MAC Address Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:macaddresslookup-api:1.1.13'
}
```
...
```java
import com.apiverve.macaddresslookup.MACAddressLookupAPIClient;
import com.apiverve.macaddresslookup.APIResponse;
import com.apiverve.macaddresslookup.APIException;

// Initialize the client
MACAddressLookupAPIClient client = new MACAddressLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("mac", "00-B0-D0-63-C2-26");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/macaddresslookup](https://docs.apiverve.com/ref/macaddresslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/macaddresslookup](https://docs.apiverve.com/ref/macaddresslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/macaddresslookup-api/issues)
