...
const (
	baseURL        = "https://api.apiverve.com/v1/macaddresslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the MAC Address Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new MAC Address Lookup API client.
...
// Execute makes a request to the MAC Address Lookup API with typed parameters.
//
