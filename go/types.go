// Package macaddresslookup provides a Go client for the MAC Address Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/macaddresslookup?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the MAC Address Lookup API.
//
// Parameters:
//   - mac (required): string - The MAC address for which you want to get the data (e.g., 00-B0-D0-63-C2-26)
type Request struct {
...
// ResponseData contains the data returned by the MAC Address Lookup API.
type ResponseData struct {
	Mac string `json:"mac"`
	Vendor string `json:"vendor"`
	DotNotation string `json:"dotNotation"`
	HexFormat string `json:"hexFormat"`
	BitReversed string `json:"bitReversed"`
	ByteString string `json:"byteString"`
